...
// Given the current kexit_info, drains any leftover gas, and returns how much gas
// was drained.
%macro drain_leftover_gas
    // stack: kexit_info
    DUP1 %leftover_gas
    %stack (leftover_gas, kexit_info) -> (leftover_gas, kexit_info, leftover_gas)
    %charge_gas
    // stack: kexit_info, leftover_gas
%endmacro
