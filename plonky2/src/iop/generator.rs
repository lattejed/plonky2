...
impl Default for CopyGenerator {
    fn default() -> Self {
        Self {
            src: Target::VirtualTarget { index: 0 },
            dst: Target::VirtualTarget { index: 0 },
        }
    }
}
...
impl Default for RandomValueGenerator {
    fn default() -> Self {
        Self {
            target: Target::VirtualTarget { index: 0 },
        }
    }
}
...
impl Default for NonzeroTestGenerator {
    fn default() -> Self {
        Self {
            to_test: Target::VirtualTarget { index: 0 },
            dummy: Target::VirtualTarget { index: 0 },
        }
    }
}
...
impl<F: Field> Default for ConstantGenerator<F> {
    fn default() -> Self {
        Self {
            row: 0,
            constant_index: 0,
